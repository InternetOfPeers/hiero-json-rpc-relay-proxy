...
describe("ethTxDecoder", () => {
  it("should decode a legacy Ethereum transaction and extract the to address", () => {
    const rawTx =
  ...
  it("should return null for contract creation transaction", () => {
    const rawTx =
  ...
  it("should decode a simple RLP string", () => {
  ...
  it("should decode a simple RLP list", () => {
  ...
  it("should return null for invalid transaction", () => {
