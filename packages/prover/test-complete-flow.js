...
console.log(
  '   ✅ Intelligent completion detection based on challenge activity'
);
...
console.log('   {');
console.log(
  '     "session": { startTime, endTime, duration, status, reason, ... },'
);
console.log(
  '     "payload": { created, routes, originalSize, encryptedSize },'
);
console.log('     "hedera": { submitted, sequenceNumber, error },');
console.log(
  '     "challenges": { serverStarted, received[], totalCount, ... },'
);
console.log('     "errors": [ ... ]');
console.log('   }');
