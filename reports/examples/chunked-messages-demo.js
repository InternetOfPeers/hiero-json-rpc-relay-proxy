...
const chunk2 = {
  ...
  message:
    'OG9Wa05BeHAvd3pYb2VHVDV4SUFXd0tNb3BoTUM3UFVWQ05GWGJRNS8waW1ROFBxeFZ6Mmd0VDJqZi93ejFISmpud2cxaHhiRUEifQ==',
  payer_account_id: '0.0.1545',
  running_hash:
    '6qEQnXqVgX2qJoTuXeY14OSm085RTW3UhY2Y1xP9sG8ZxRJ0yBZQroFMSWNbYUZT',
  running_hash_version: 3,
  sequence_number: 3,
  topic_id: '0.0.6139083',
};
...
if (result2) {
  ...
  try {
    ...
    console.log(
      `   ✅ Combined content is valid JSON with keys: ${Object.keys(parsed).join(', ')}`
    );
  } catch (error) {
...
console.log(
  '   ✅ Order-independent chunk assembly (chunks can arrive out of order)'
);
...
console.log(
  '   6. Combined message processed normally (decrypt, verify, etc.)'
);
